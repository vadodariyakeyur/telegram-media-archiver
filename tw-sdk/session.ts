...
import type { FoundItem, MediaKind, ScanResult } from './types';

export class Session {
  scan: ScanResult | null = null;      // last scan result, reused by CONTINUE and DOWNLOAD
  chatKey: string | null = null;   // the chat that scan belongs to

  record(scan: ScanResult, chatKey: string | null): this {
    this.scan = scan;
  ...
  invalidateIfChatChanged(nowKey: string | null): boolean {
